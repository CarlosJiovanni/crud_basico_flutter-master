...
class _MyHomePage extends State<MyHomePage> {
  List<Client> clients = [
    Client(name: 'Luis', surname: 'Chávez', phone: '302 454 25 93'),
    Client(name: 'Jiovanni', surname: 'Prieto', phone: '322 412 34 68'),
    Client(name: 'Abi', surname: 'Chávez', phone: '301 441 36 98'),
    Client(name: 'Mamá', surname: '', phone: '310 789 90 62')
  ];
